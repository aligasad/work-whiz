...
const ChartPage = () => {
  return (
    <div className="bg-gradient-to-br from-white to-blue-200 px-4 sm:px-6 lg:px-8 py-6 max-w-7xl mx-auto">
      <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-6 text-center mt-20">
        WorkWhiz Dashboard
      </h1>
